...
class _Buildings extends State<Buildings> {
  var data1,data2;
  var statusCode1=0;
  var statusCode2=0;
  ...
  Future getData() async{
    ...
    var url = "https://insurence-manager.herokuapp.com/fire_misc";
    var url1 = "https://insurence-manager.herokuapp.com/renew_fire_misc";
                  ...
                  child:PopupMenuButton(itemBuilder: (context)=>[
                        ...
                        child:GestureDetector(
                          ...
                          onTap: (){
                            Navigator.push(context,
                                MaterialPageRoute(builder: (context)=>EditRecord(data:element,type: "3",))
                            );
                          },
                        )
                    ),
                    PopupMenuItem(
                        child: GestureDetector(
                          ...
                          onTap: (){
                            Navigator.push(context,
                                MaterialPageRoute(builder: (context)=>RenewRecord(data:element,type: "3",))
                            );
                          },
                        )
                    ),
                    PopupMenuItem(
                        child: GestureDetector(
                          ...
                          onTap: (){
                            Navigator.push(context,
                                MaterialPageRoute(builder: (context)=>ViewScreen1(data:element))
                            );
                          },
                        )
                    )
            ...
            child:ListView(children:[ SingleChildScrollView(
                ...
                child: DataTable(
                    columns: [
                      ...
                      DataColumn(
                          label: Text("Reference", style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 15),
                              softWrap: true)
                      ),
                      DataColumn(
                          label: Expanded(child: Text("Policy Number",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold, fontSize: 15),
                              softWrap: true),)
                      ),
                      DataColumn(
                          label: Expanded(child: Text("Policy Type",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold, fontSize: 15),
                              softWrap: true),)
                      ),
                      ...
                      DataColumn(
                          label: (Text("Renewal", style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 15)))
                      ),
                      DataColumn(
                      ...
                      DataColumn(
                          label: Text("Mail ID", style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 15),
                              softWrap: true)
                      ),
                      DataColumn(
                    ...
                    rows: statusCode1 == 200
                        ? List.generate(
                        data1.length, (index) => _getDataRow(data1[index]))
                        : [
                      DataRow(
                          cells: [
                            DataCell(Text(" ")),
      ...
      child: SizedBox(
          ...
          child:ListView(children:[SingleChildScrollView(
              ...
              child: DataTable(
                  ...
                  rows: statusCode2 == 200 ? List.generate(
                      data2.length, (index) => _getDataRow(data2[index])) : [
                    DataRow(
                        cells: [
                          DataCell(Text(" ")),
                          DataCell(Text(" ")),
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Align(alignment:Alignment.centerLeft,
            child: Text("Fire & Miscellanious",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20))
        ,),
        SizedBox(height: 15),
        ButtonBar(
        ...
        select==1?getAllRecords():getRenewRecords(),
