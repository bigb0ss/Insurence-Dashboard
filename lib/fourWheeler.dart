...
class _FourWheeler extends State<FourWheeler> {
  var data1,data2;
  var statusCode1=0;
  var statusCode2=0;
  ...
  Future getData() async{
    ...
    var url = "https://insurence-manager.herokuapp.com/mvehicle";
    var url1 = "https://insurence-manager.herokuapp.com/renew_mvehicle";
                  ...
                  child:PopupMenuButton(itemBuilder: (context)=>[
                        ...
                        child:GestureDetector(
                          ...
                          onTap: (){
                            Navigator.push(context,
                                MaterialPageRoute(builder: (context)=>EditRecord(data:element,type: "2",))
                            );
                          },
                        )
                    ),
                    PopupMenuItem(
                        child: GestureDetector(
                          ...
                          onTap: (){
                            Navigator.push(context,
                                MaterialPageRoute(builder: (context)=>RenewRecord(data:element,type: "2",))
                            );
                          },
                        )
                    ),
      ...
      Column(
        ...
        children: <Widget>[
          SizedBox(
            ...
            child: Text("Goods & Miscellanious Vehicles",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20))
            ,),
          SizedBox(height:15),
          ButtonBar(
